...
#define TOTAL_TRANSFER_SIZE (32 * 1024U)
...
static uint8_t tx_buffer[2304] __aligned(4); /* Largest buffer size */
static uint8_t rx_buffer[2304] __aligned(4); /* Largest buffer size */
